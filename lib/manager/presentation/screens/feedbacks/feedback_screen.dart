...
class ManagerFeedbackScreen extends StatelessWidget {
  const ManagerFeedbackScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('FeedBacks').orderBy('date',descending: true).snapshots(),
